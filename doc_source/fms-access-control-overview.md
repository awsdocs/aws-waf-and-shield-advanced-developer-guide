...
To express conditions, you use predefined condition keys\. There are no condition keys specific to Firewall Manager\. However, there are general AWS condition keys that you can use as appropriate\. For a complete list of AWS keys, see [Available Keys for Conditions](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_policies_elements.html#AvailableKeys) in the *IAM User Guide*\.