# Troubleshooting AWS Firewall Manager identity and access<a name="fms-security_iam_troubleshoot"></a>
...
## I am not authorized to perform an action in Firewall Manager<a name="fms-security_iam_troubleshoot-no-permissions"></a>
...
## I am not authorized to perform iam:PassRole<a name="fms-security_iam_troubleshoot-passrole"></a>
...
## I want to allow people outside of my AWS account to access my Firewall Manager resources<a name="fms-security_iam_troubleshoot-cross-account-access"></a>
