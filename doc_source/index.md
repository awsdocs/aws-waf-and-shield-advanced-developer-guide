...
+ [AWS Shield](shield-chapter.md)
   + [How AWS Shield works](ddos-overview.md)
      + [AWS Shield Standard](ddos-standard.md)
      + [AWS Shield Advanced](ddos-advanced.md)
      ...
      + [Types of DDoS attacks](types-of-ddos-attacks.md)
      + [The AWS Shield Response Team (SRT)](ddos-drt.md)
