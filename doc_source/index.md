...
+ [AWS WAF](waf-chapter.md)
   ...
   + [AWS WAF managed protections](waf-managed-protections.md)
      ...
      + [AWS WAF Fraud Control account takeover prevention (ATP)](waf-atp.md)
         + [Using the ATP managed rule group](waf-atp-rg-using.md)
...
+ [AWS Shield](shield-chapter.md)
   ...
   + [Getting started with AWS Shield Advanced](getting-started-ddos.md)
      ...
      + [Add resources to protect and configure protections](ddos-choose-resources.md)
         + [Configure application layer (layer 7) DDoS protections](ddos-get-started-rate-based-rules.md)
         + [Configure health-based detection for your protections](ddos-get-started-health-checks.md)
         + [Create alarms and notifications](ddos-get-started-create-alarms.md)
         + [Review and configure your protections settings](ddos-get-started-review-and-configure.md)
   ...
   + [Security in your use of the AWS Shield service](shd-security.md)
      ...
      + [Identity and access management in AWS Shield Advanced](shd-auth-and-access-control.md)
         ...
         + [AWS managed policies for AWS Shield Advanced](shd-security-iam-awsmanpol.md)
