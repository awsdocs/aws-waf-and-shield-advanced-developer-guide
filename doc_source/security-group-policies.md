...
**Note**  
If you have also chosen to remove unused security groups, Firewall Manager does that next\. This can result in the removal of the security groups that are in the redundant set, if they are still disassociated from all resources\.
